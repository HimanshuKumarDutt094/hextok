 ...
 */
class LynxLinkingActivityListener : Application.ActivityLifecycleCallbacks {
  private val TAG = "LynxLinkingActivityListener"
  ...
  private fun onReceiveURL(intent: Intent?) {
    try {
      ...
      if (data != null) {
        LynxLinkingModule.initialUrl = data.toString()
