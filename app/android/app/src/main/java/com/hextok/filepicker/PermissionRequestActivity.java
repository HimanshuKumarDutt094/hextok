...
public class PermissionRequestActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                ...
                com.hextok.filepicker.FilePermissionModule.deliverPermissionResult(true);
                finish();
            }
        } catch (Exception e) {
            com.hextok.filepicker.FilePermissionModule.deliverPermissionResult(false);
            finish();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQ_MANAGE) {
            ...
            com.hextok.filepicker.FilePermissionModule.deliverPermissionResult(granted);
        }
        finish();
    }
}
